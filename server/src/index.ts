...
app.use(cors({credentials: true, origin: ["https://gl.jeremycarder.ca", "https://grocerylist-1.onrender.com", "http://localhost:4173", "http://localhost:5173", "https://localhost:4433", "http://192.168.1.253:5173", "http://192.168.1.247:5173"]}));
